...
import {handler} from "../lambdas/menu/get/get_menu";
...
jest.mock('postgresql-easy', () => {
  return {
    ...
    default: jest.fn().mockImplementation(() => {
      return {
        getById: jest.fn().mockImplementation(()=>Promise.resolve({"id":1,"value":"some_value"})),
        disconnect : jest.fn()
      };
    }),
  };
...
describe('test create menu function', () => {
  ...
  test('should be able to create menu', () => {
